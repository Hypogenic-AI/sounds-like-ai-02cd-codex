...
% Fallback for NeurIPS 2025 track name if not set by package options
\makeatletter
\providecommand{\@trackname}{NeurIPS 2025}
\makeatother
...
% Customize algorithm appearance (guard if algorithmic package is not loaded)
